    ...
    <tr className='border-b hover:bg-gray-200'>
      ...
      <td className='p-3'>
        ...
        <p>
          ...
          <span className={telefono ? '' : 'italic text-gray-600'}>{telefono ? telefono : '<vacío>'}</span>
        </p>
      </td>
      ...
      <td className='p-3'>
        <button
          type="button"
          className='bg-orange-500 hover:bg-orange-600 block w-full text-white p-2 uppercase font-bold text-xs'
